...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Core Banking System : Withdraw</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12 well" id="content">
                            ...
                            <h2 class="title text-center">WITHDRAW</h2>
                            <h3 class="title text-center">Please enter your account number to withdraw.</h3>
                            <br>

                                <!--Making form is started from here-->
                                <form:form class="form-withdraw" method="POST" modelAttribute="withdraw" action="withdrawProcess">
                                  ...
                                  <br>
                                  <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">Withdraw</button>
