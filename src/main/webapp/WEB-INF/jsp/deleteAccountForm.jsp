...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Core Banking System : Delete Account</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12 well" id="content">
                            ...
                            <h3 class="title text-center">Please enter your account details to delete Account.</h3>
                            <br>

                                <!--Making form is started from here-->
                                <form:form class="form-delete" method="POST" modelAttribute="delete" action="deleteAccountProcess">
                                  <div class="form-label-group">
                                    <label for="accNo">Account Number</label>
                                    <form:input type="text" id="accNo" path="accNo" name="accNo" value='<%= request.getParameter("accNo")%>' class="form-control" placeholder="Account Number" minlength="1" required="required"/>
                                  </div>
