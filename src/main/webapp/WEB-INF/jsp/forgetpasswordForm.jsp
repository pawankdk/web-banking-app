...
<head>
    ...
    <style>
        body
        {
            background: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbqwjBP3MVApahCtAy-rkDUyQLAsUkFCasQw&usqp=CAU);
        }
        .container-fluid
        {
...
<body>
    ...
    <div class="container-fluid" style="  width: 40%;">
        ...
        <h2>${message}</h2>
            ...
            <form:form class="form-forgetpassword" method="POST" modelAttribute="forgetpassword" action="forgetpasswordProcess">
              ...
              <a class="btn btn-lg btn btn-info btn-forget_password btn-block text-uppercase" href="/"><span class="text">Login Form</span></a>
