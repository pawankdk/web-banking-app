...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Core Banking System : Account Details</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12 well" id="content">
                            ...
                            <h2 class="title text-center">ACCOUNT DETAILS</h2>
                            <h3 class="title text-center">Account details of required account.</h3>
                            <br>

                                <!--Making form is started from here-->                                  
                                <form:form class="form-accountdetails" method="POST" modelAttribute="accountdetails" action="">
                                  ...
                                  <div class="form-label-group">
                                    ...
                                    <form:input type="text" id="name" class="form-control" path="name" name="name" readonly="true" value='<%= request.getParameter("name")%>' placeholder="Account Name" minlength="1" required="required"/>
                                  </div>
                                  
                                  <div class="form-label-group">
                                    <label for="address">Address</label>
                                    <form:input type="text" id="address" class="form-control" path="address" name="address" readonly="true" value='<%= request.getParameter("address")%>' placeholder="Address" minlength="1" required="required"/>
                                  </div>
