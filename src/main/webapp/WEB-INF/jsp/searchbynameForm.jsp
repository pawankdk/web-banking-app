...
<%@ page import="com.mycompany.CoreBank.entity.Account"%>
...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Core Banking System : Search By Name</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12 well" id="content">
                            ...
                            <h2 class="title text-center">SEARCH BY NAME</h2>
                            <h3 class="title text-center">Please enter Account Name to search.</h3>
                            <br>

                                <!--Making form is started from here-->
                                <form:form class="form-search" method="POST" modelAttribute="search" action="searchProcess">
                                  <div class="form-label-group">
                                    <label for="accNo">Account Number</label>
                                    <form:input type="text" id="name" path="name" name="name" class="form-control" placeholder="Account Name" minlength="1" required="required"/>
                                  </div>
                            ...
                            <h3 class="title text-center">List of searched Account.</h3>
                                ...
                                <%
                                    ...
                                    { %>
                                        <tr>
                                            ...
                                            <td><a class="btn btn-info" href="accountdetails?accNo=<%out.print(a.getAccNo());%>&name=<%out.print(a.getName());%>&address=<%out.print(a.getAddress());%>&amount=<%out.print(a.getAmount());%>&accType=<%out.print(a.getAccType());%>"><span class="text">Details</span></a>
                                                <a class="btn btn-success" href="editaccountdetails?accNo=<%out.print(a.getAccNo());%>&name=<%out.print(a.getName());%>&address=<%out.print(a.getAddress());%>&amount=<%out.print(a.getAmount());%>&accType=<%out.print(a.getAccType());%>"><span class="text">Edit</span></a>
                                                <a class="btn btn-danger" href="deleteaccount?accNo=<%out.print(a.getAccNo());%>"><span class="text">Delete</span></a> 
                                            </td>
                                        </tr>
                                 <% }
                                %>
