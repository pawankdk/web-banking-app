...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Core Banking System : Create New Account</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12 well" id="content">
                            ...
                            <h2 class="title text-center">CREATE NEW ACCOUNT</h2>
                            <h3 class="title text-center">Please enter account details to create new account.</h3>
                            <br>

                                <!--Making form is started from here-->
                                <form:form class="form-newaccount" method="POST" modelAttribute="newAccount" action="newAccountProcess">
                                  <div class="form-label-group">
                                    <label for="accNo">Account Number</label>
                                    <form:input type="text" id="accNo" path="accNo" name="accNo" class="form-control" placeholder="Account Number" minlength="1" required="required"/>
                                  </div>
                                  
                                  <div class="form-label-group">
                                    <label for="name">Account Name</label>
                                    <form:input type="text" id="name" class="form-control" path="name" name="name" placeholder="Account Name" minlength="1" required="required"/>
                                  </div>
                                  
                                  <div class="form-label-group">
                                    <label for="address">Address</label>
                                    <form:input type="text" id="address" class="form-control" path="address" name="address" placeholder="Address" minlength="1" required="required"/>
                                  </div>
                                  
                                  <div class="form-label-group">
                                    <label for="amount">Amount to Withdraw</label>
                                    <form:input type="text" id="amount" class="form-control" path="amount" name="amount" placeholder="Ammount" minlength="1" required="required"/>
                                  </div>
                                  
                                  <br>
                                  <div class="form-label-group">
                                    <label for="accType">Amount to Withdraw</label>
                                    <form:select path="accType">
                                        <form:option value="C" label="Current Account"/>
                                        <form:option value="F" label="Fixed Account"/>
                                        <form:option value="S" label="Savings Account"/>
                                    </form:select>
                                  </div>
