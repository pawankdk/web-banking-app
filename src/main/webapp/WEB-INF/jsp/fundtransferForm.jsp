...
<html lang ="en">
    <head>
        ...
        <!--Title Name-->
        <title>Core Banking System : Fund Transfer</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="main" >
                        <div class="col-sm-12 col-md-12 well" id="content">
                            ...
                            <h2 class="title text-center">FUND TRANSFER</h2>
                            <h3 class="title text-center">Please enter Accounts details to Fund Transfer.</h3>
                            <br>

                                <!--Making form is started from here-->
                                <form:form class="form-fundtransfer" method="POST" modelAttribute="fundDetail" action="fundtransferProcess">
                                  <div class="form-label-group">
                                    <label for="accNoSource">Account Number of Source</label>
                                    <form:input type="text" id="scrAccNo" path="srcAccNo" name="srcAccNo" class="form-control" placeholder="Source Account Number" minlength="1" required="required"/>
                                  </div>
                                  
                                  <div class="form-label-group">
                                    <label for="accNoTarget">Account Number of Target</label>
                                    <form:input type="text" id="trgtAccNo" path="trgtAccNo" name="trgtAccNo" class="form-control" placeholder="Target Account Number" minlength="1" required="required"/>
                                  </div>

                                  <div class="form-label-group">
                                    <label for="amount">Amount to Transfer</label>
                                    <form:input type="text" id="amount" class="form-control" path="amount" name="amount" placeholder="Ammount to Transfer" minlength="1" required="required"/>
                                  </div>
                                  <hr style="border-color: #000; ">
                                  <br>
                                  <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">Fund Transfer</button>
